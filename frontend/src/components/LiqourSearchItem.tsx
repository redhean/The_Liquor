...
export default function LiqourSearchItem({data = dummyData.liquor_list[0]} : {data: LiqourSearchItemProps}) {
    return (
        <div className="grid grid-cols-[7rem,_auto] gap-4 bg-slate-200 p-2">
            ...
            <div className="flex flex-col justify-center gap-2 py-1">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-700 leading-3">{data.english_name}</p>
                </div>
